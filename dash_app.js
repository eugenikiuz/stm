...
// ============================================================
const NOTES=[
  "С апреля 2025 подключён Яндекс Бизнес — он дал заметный рост трафика и целевых действий. К лету источник «настроился»: стоимость целевого действия снизилась со 126 ₽ (апрель) до ~95–100 ₽, отказы упали с 47% до 26%, конверсия в целевого клиента выросла с 14,4% до 27,6%.",
  "Всплеск целевых действий в октябре 2025 связан с работами по сайту, а не с ростом спроса — учитываем это при сравнении месяцев.",
  "С июня 2026 запущена контекстная реклама в Директе с посадкой на сайт и отдельный лендинг. Это дало резкий рост трафика, ЦД также значительно выросли (посетители июня 5138 против ~1300 месяцем ранее). Это ожидаемый эффект нового платного канала.",
  "В контексте лучше всего отработали РСЯ-имплантация и брендовые запросы — самая низкая стоимость ЦД. В июле РСЯ-имплантация усилилась: целевых действий вдвое больше при более низкой цене. Ретаргетинг и РСЯ «лечение во сне» дали дорогие ЦД и были отключены.",
];
